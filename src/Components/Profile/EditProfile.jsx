...
const EditProfile = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      ...
      .patch(
        `https://backend-qyb4mybn.b4a.run/profile/edit-profile/${user_id}`,
        profileData
      )
      .then((response) => {
      ...
      {updating ? (
        ...
        <div className="flex justify-center items-center min-h-screen">
          <div className="p-6 w-full max-w-2xl">
            <h2 className="mb-4 font-bold text-2xl text-center">Profile</h2>
            ...
            <div className="flex flex-col items-center mb-4">
              <div className="relative">
                ...
                <img
                  src={imageUrl}
                  alt="Profile"
                  className="mb-2 rounded-full w-24 h-24 cursor-pointer object-cover"
              ...
              <div className="mb-4 w-full">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  {selectedLanguages.map((lang) => (
                    <div
                      key={lang}
                      className="flex items-center bg-blue-100 px-3 py-1 rounded-full text-blue-700"
                    >
                      {lang}
                      <select
                        className="border-gray-300 ml-2 p-1 rounded-lg"
              ...
              <div className="mb-4 w-full">
                ...
                {showCustomSkillInput && (
                  <div className="flex items-center mt-2">
                    ...
                    <button
                      type="button"
                      className="bg-custom-violet hover:bg-violet-700 ml-2 px-3 py-2 rounded-lg text-white"
